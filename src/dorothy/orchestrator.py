...
from .models import Album, ResourceId, Song, Artist, SongResourceId, AlbumResourceId, ArtistResourceId
...
class Orchestrator:
    ...
    def insert_to_queue(
        ...
        If the insert position is greater than the queue size then the call is ignored.
    ...
    def remove_from_queue(self, channel: str, remove_position: int) -> None:
        ...
        If the index position is greater than the queue size then the call is ignored.
    ...
    def get_queue(self, channel: str) -> list[Song]:
        ...
        return self._channels[channel].queue
    ...
    def get_channel_state(self, channel: str) -> ChannelStates:
        ...
        :return: The current state of the given given channel.
        """
    ...
    def _cleanup_nodes(self) -> None:
        ...
        self._logger.info("Cleaning listener nodes...")
